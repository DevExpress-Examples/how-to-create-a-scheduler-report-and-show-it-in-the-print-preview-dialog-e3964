...
Namespace CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarsTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WpfApplication1.MySettings.Default.CarsDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, TransmissAutoma"& _ 
                "tic, MPG_City, MPG_Highway, Category, Description, Hyperlink, Picture, Price, Rt"& _ 
                "fContent FROM Cars"
